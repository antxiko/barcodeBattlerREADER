...
void imprimirChurro(){                      //This function prints the bit stream in binary and then in ASCII
    Serial.println("Esto es lo que hemos leido desde el Barcode con una Pi Pico");
  for (int c=0; c<205;c++)
    {
    Serial.print(churro[c]);
    }
    Serial.println();
    Serial.println("0000011001000101100100000110010100011001001001100100000110010111011001011001100101100110010011011001010101100100000110010100011001010100010100000101010111100101011000010100001001010101100001001010000111111");
    Serial.println();
